...
#ifndef __IMAGEPROCESSINGBUFFERCUDANODE_H__
#define __IMAGEPROCESSINGBUFFERCUDANODE_H__
...
namespace supra
{
	class ImageProcessingBufferCudaNode : public AbstractNode {
	public:
		ImageProcessingBufferCudaNode(tbb::flow::graph& graph, const std::string & nodeID, bool queueing);
...
#endif //!__IMAGEPROCESSINGBUFFERCUDANODE_H__
